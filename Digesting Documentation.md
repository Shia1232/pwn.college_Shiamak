...
These are called builtins. Builtins are invoked just like commands, but the shell handles them internally instead of  
launching other programs. You can get a list of shell builtins by running the builtin help, as so:  
```
hacker@dojo:~$ help
```
You can get help on a specific one by passing it to the help builtin. Let's look at a builtin that we've already used  
earlier, cd!  
```
hacker@dojo:~$ help cd
cd: cd [-L|[-P [-e]] [-@]] [dir]
...
...
```
Some good information! In this challenge, we'll practice using help to look up help for builtins. This challenge's  
challenge command is a shell builtin, rather than a program. Like before, you need to lookup its help to figure out  
the secret value to pass to it!  
### Solve  
**Flag:** `pwn.college{QFtGOMThD6Bi5CjYcaWNUPhehQa.QX0ETO0wCN1kjNzEzW}`  
I used the help command with challenge as an argument to get more information on its special usages,  
which gave me the special ``--secret`` argument and the secret value.  
```
...
challenge: challenge [--fortune] [--version] [--secret SECRET]
    ...
    is "QFtGOMTh".
hacker@man~help-for-builtins:~$ challenge --secret QFtGOMTh
Correct! Here is your flag!
pwn.college{QFtGOMThD6Bi5CjYcaWNUPhehQa.QX0ETO0wCN1kjNzEzW}
```
### New Learnings  
I learnt how to use the help command for built-ins which don't have man pages.  
### Resources  
